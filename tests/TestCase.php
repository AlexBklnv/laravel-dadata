...
use AlexBklnv\DaData\DaDataServiceProvider;
...
class TestCase extends \Orchestra\Testbench\TestCase
{
    ...
    {
        return [
            'DaDataAddress' => DaDataAddress::class,
        ];
    }
    ...
    protected function defineEnvironment($app)
    {
        ...
        $app['config']->set('dadata', [
            'token' => env('DADATA_TOKEN', '0adb75ef3ff2410ac05104e713645ec6af91c117'),
            'secret' => env('DADATA_SECRET', '842631498aa9d43dba49111df7e5b0827ba774bb'),
        ]);
    }
     ...
     * @return array|array[]
     **/
    public function cleanAddressProvider(): array
    {
        return [
            [
     ...
     * @return array|\array[][]
     */
    public function geoCoordinatesProvider(): array
    {
        return [
            "suggestions" => [
                [
     ...
     * @return array|\array[][]
     */
    public function suggestionsAddressProvider(): array
    {
        return [
            "suggestions" => [
                [
